...
def find_major_commons(name, client, data_json):
    ...
    request_to_gpt = (
        ...
        f"#回答形式:\n"
        f"まず共通点だけを、太字で書いてください。\n"and
        f"その後に半角スペースを2つ入れ、改行してしてください。\n"
        f"先ほどの共通点が、誰と共通しているかを説明してください。\n"
...
def find_similar_person(name, client, data_json):
    ...
    request_to_gpt = (
        ...
        f"その後に半角スペースを2つ入れた後に改行をしてください。その次に、その人が{name}とどういう点が共通または類似しているのかを書いてください。\n"
